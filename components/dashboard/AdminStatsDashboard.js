  ...
  return (
    <div className="space-y-3 sm:space-y-4 lg:space-y-6 px-3 sm:px-4 lg:px-6 py-3">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl lg:text-2xl font-bold text-black">Admin Dashboard</h2>
          <p className="text-sm text-gray-600 mt-1">Overview of system metrics and performance</p>
        </div>
        ...
        <div className="bg-white border border-gray-100 rounded-lg p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
              ...
              <div className="text-2xl font-bold text-amber-600">{stats.tasks?.pending || 0}</div>
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              ...
              <div className="text-2xl font-bold text-blue-600">{stats.tasks?.completionRate || 0}%</div>
            </div>
          </div>
        </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4">
      ...
      <div className="text-lg font-semibold text-gray-900">
        {stats.tasks?.completionRate > 75 ? 'Excellent' : stats.tasks?.completionRate > 50 ? 'Good' : 'Needs Attention'}
      </div>
  ...
  <div className="space-y-4">
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <div className="text-center p-3 bg-purple-50 rounded-lg">
        <div className="text-2xl font-bold text-purple-600">{stats.clients?.length || 0}</div>
...
const RecentActivitySection = ({ stats }) => (
  <div className="space-y-3">
    <div className="text-sm text-gray-600 mb-4">Recent system activity and updates</div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">
                Assigned to {task.assigned_to} • {task.client_name || 'No client'}
              </div>
            </div>
          </div>
          <div className="text-right">
